        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3 lg:gap-12">
          ...
          <div className="flex flex-col items-start space-y-4">
            <Link href="/" className="flex items-center gap-2">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-cyan-50 text-cyan-700 shadow-sm">
                <HeartPulse className="h-5 w-5" />
              </div>
              <span className="font-serif text-xl font-bold tracking-tight text-slate-900">
                Medi<span className="text-cyan-700">Integral</span>
              </span>
            </Link>
          ...
          <div className="flex flex-col space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="#inicio" className="hover:text-cyan-700 transition-colors">
                  Inicio
                </Link>
              </li>
              <li>
                <Link href="#servicios" className="hover:text-cyan-700 transition-colors">
                  Especialidades
                </Link>
              </li>
              <li>
                <Link href="#nosotros" className="hover:text-cyan-700 transition-colors">
                  Nosotros
                </Link>
              </li>
              <li>
                <Link href="#contacto" className="hover:text-cyan-700 transition-colors">
                  Contacto
                </Link>
              </li>
            </ul>
          ...
          <div className="flex flex-col space-y-3">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <a 
                ...
                aria-label="Facebook"
                className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 text-slate-600 hover:bg-cyan-50 hover:border-cyan-200 hover:text-cyan-700 transition-all shadow-sm"
              >
